            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                <div className="mx-auto mb-9 text-center">
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <stop stopColor="#2186EB" stopOpacity="0" />
                        <stop offset="1" stopColor="#2186EB" />
                      </linearGradient>
                      <linearGradient
                ...
                <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                  Страница, которую вы искали, была перемещена, удалена или не
                  существует.
                </p>
                <Link
                  href="/"
          ...
          >
            ...
            <defs>
              ...
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#2186EB" />
                <stop offset="1" stopColor="#2186EB" stopOpacity="0" />
              </linearGradient>
              <linearGradient
